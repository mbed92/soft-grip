...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-path-test', type=str, default="./data/dataset/ds_IMU_no_contact_sense_full/unseen.pickle")
    parser.add_argument('--results-dir', type=str, default="./data/logs/CNN_RNN_FC_v2")
